  ...
  DateFormatter.prototype = {
    ...
    parseFormat: function (vChar, vDate)
    {
      ...
      fmt = {
        ...
        j: function ()
        {
          return fmt.useUtc() ? vDate.getUTCDate() : vDate.getDate();
        },
        /**
        ...
        w: function ()
        {
          return fmt.useUtc() ? vDate.getUTCDay() : vDate.getDay();
        },
        /**
         * Day of year: `0..365`
         * @return {number}
        ...
        F: function ()
        {
          return vSettings.months[ fmt.useUtc() ? vDate.getUTCMonth() : vDate.getMonth()];
        },
        /**
        ...
        M: function ()
        {
          return vSettings.monthsShort[ fmt.useUtc() ? vDate.getUTCMonth() : vDate.getMonth()];
        },
        /**
         * Month: `1...12`
         * @return {number}
        ...
        n: function ()
        {
          return  (fmt.useUtc() ? vDate.getUTCMonth() : vDate.getMonth()) + 1;
        },
        /**
         * Days in month: `28...31`
         * @return {number}
        ...
        Y: function ()
        {
          return  fmt.useUtc() ? vDate.getUTCFullYear() : vDate.getFullYear();
        },
        /**
        ...
        G: function ()
        {
          return fmt.useUtc() ? vDate.getUTCHours() : vDate.getHours();
        },
        /**
        ...
        i: function ()
        {
          return _lpad(fmt.useUtc() ? vDate.getUTCMinutes() : vDate.getMinutes(), 2);
        },
        /**
        ...
        s: function ()
        {
          return _lpad(fmt.useUtc() ? vDate.getUTCSeconds() : vDate.getSeconds(), 2);
        },
        /**
        ...
        u: function ()
        {
          return _lpad((fmt.useUtc() ? vDate.getUTCMilliseconds() : vDate.getMilliseconds()) * 1000, 6);
        },
        //////////////
        // TIMEZONE //
        //////////////
              ...
              .on('xchange.xdsoft', function (event)
              {
                ...
                xchangeTimer = setTimeout(function ()
                {
                  ...
                  line_time = function line_time(h, m)
                  {
                    ...
                    classes = [];
                    if ((options.minDateTime !== false && options.minDateTime > optionDateTime) || (options.maxTime !== false && _xdsoft_datetime.strtotime(options.maxTime).getTime() < optionDateTime.getTime()) || (options.minTime !== false && _xdsoft_datetime.strtotime(options.minTime).getTime() > optionDateTime.getTime()))
                    {
                      classes.push('xdsoft_disabled');
                    }
                    if ((options.minDateTime !== false && options.minDateTime > optionDateTime) || ((options.disabledMinTime !== false && optionDateTime.getTime() > _xdsoft_datetime.strtotime(options.disabledMinTime).getTime()) && (options.disabledMaxTime !== false && optionDateTime.getTime() < _xdsoft_datetime.strtotime(options.disabledMaxTime).getTime())))
                    {
                      classes.push('xdsoft_disabled');
                    }
