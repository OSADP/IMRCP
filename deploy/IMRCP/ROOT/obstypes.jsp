<%@page contentType="application/json" pageEncoding="UTF-8"%><%@page import="imrcp.system.ObsType"%><%@page import="java.util.HashMap"%><%
  ...
  oObstypeFields.put(ObsType.TAIR, new String[]{"Air Temp", "\"#aa00ff\", \"#00007f\", \"#0000ff\", \"#00af20\", \"#ffc700\", \"#ff751a\", \"#ff0000\"", "20,33,40,60,80,95", "\"Below 20\", \"20 - 32\", \"33 - 39\", \"40 - 59\", \"60 - 79\", \"80 - 95\", \"Above 95\""});
  oObstypeFields.put(ObsType.GSTWND, new String[]{"Wind Gust Speed", "\"#aacfeb\", \"#567593\", \"#325972\", \"#003050\"", "5, 15, 25", "\"Below 5\", \"5 - 15\", \"15 - 25\", \"Above 25\""});
  oObstypeFields.put(ObsType.SPDWND, new String[]{"Wind Speed", "\"#aacfeb\", \"#567593\", \"#325972\", \"#003050\"", "5, 15, 25", "\"Below 5\", \"5 - 15\", \"15 - 25\", \"Above 25\""});
  ...
  oObstypeFields.put(ObsType.PCCAT, new String[]{"Precip Rate and Type", 
    "\"#ffffff\",\"#80ff80\",\"#00af20\",\"#00561e\"," +
    "\"#d9b3ff\",\"#8b4baf\",\"#4a0070\"," +
    "\"#80ffff\",\"#1a1aff\",\"#000066\"," +
    "\"#ffc2f1\",\"#ff4bf6\",\"#830d56\"", 
    "0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5, 8.5, 9.5, 10.5, 11.5",
    "\"No Precipitation\", \"Rain - Light\", \"Rain - Moderate\", \"Rain - Heavy\"," + 
    "\"Frz Rain - Light\", \"Frz Rain - Moderate\", \"Frz Rain - Heavy\","+ 
    "\"Snow - Light\", \"Snow - Moderate\", \"Snow - Heavy\"," +
    "\"Ice Pellets - Light\", \"Ice Pellets - Moderate\", \"Ice Pellets - Heavy\""});
