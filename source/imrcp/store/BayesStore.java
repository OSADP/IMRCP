...
/**
 * This class is a CsvStore that stores the data from the Bayes module
 *
 */
public class BayesStore extends CsvStore
{
		...
		if (oNotification.m_sMessage.compareTo("file download") == 0)
		{
			...
			if (bNewFile)
				for (int nSubscriber : m_oSubscribers) // notify subscribers that there is new bayes data
					notify(this, nSubscriber, "new bayes data", "");
		}
	}


	/**
	 * Return a new BayesCsv file wrapper
	 *
	 * @return new BayesCsv
	 */
	@Override
