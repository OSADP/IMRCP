...
public class OsmWay extends OsmObject
{
	...
	public WaySnapInfo snap(int nTol, int nX, int nY)
	{
		...
		if (!GeoUtil.isInside(nX, nY, m_nMaxLat, m_nMaxLon, m_nMinLat, m_nMinLon, nTol))
		...
		for (int nNodeIndex = 0; nNodeIndex < nLimit;)
		{
			...
			if (GeoUtil.isInside(nX, nY, o2.m_nLat, o2.m_nLon, o1.m_nLat, o1.m_nLon, nTol)) // quick check if the node is close to the line segment
			{
