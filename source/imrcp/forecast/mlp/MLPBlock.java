...
abstract public class MLPBlock extends BaseBlock
{
	...
	static
	{
		...
		g_sLongTsPredFf = oConfig.getString(sConfigName, "MLPBlock", "longtsff", "");
		...
		g_dRAINTEMPK = Double.parseDouble(oConfig.getString(sConfigName, "MLPBlock", "raintemp", "275.15"));
		g_dSNOWTEMPK = Double.parseDouble(oConfig.getString(sConfigName, "MLPBlock", "snowtemp", "271.15"));		
	...
	public void reset()
	{
		...
		m_sNetwork = m_oConfig.getString("network", "");
		m_sTz = m_oConfig.getString("tz", "");
		...
		m_sInputFf = m_oConfig.getString("inputfile", "");
	 ...
	 */
	public static int[] getIncidentData(ImrcpResultSet oEvents, OsmWay oWay, ArrayList<OsmWay> oDownstream, long lTimestamp)
	{
		int[] nReturn = new int[]
		{
			0, 0, 0, 0, 0, 0
