...
public class MLPProcess
{
		...
		throws Exception
	{
		...
		{	
			...
			ImrcpResultSet oEventData = (ImrcpResultSet)oOv.getData(ObsType.EVT, lLongTsUpdateStart, lEnd, nBb[1], nBb[3], nBb[0], nBb[2], lEnd);
				...
				while (lTimestamp < lEnd)
				{
					...
					for (int nGroupIndex = 0; nGroupIndex < oScenario.m_oGroups.length; nGroupIndex++)
					{
						...
						for (int nWayIndex = 0; nWayIndex < oRWork.size(); nWayIndex++)
						{
							...
							ImrcpObsResultSet oTemperatures = (ImrcpObsResultSet)oOv.getData(ObsType.TAIR, lTimestamp, lTimestamp + 1, oWay.m_nMidLat, oWay.m_nMidLat, oWay.m_nMidLon, oWay.m_nMidLon, lLongTsUpdateStart);
							Obs oCur = null;
							...
							oCur = null;
							ImrcpObsResultSet oVisibilities = (ImrcpObsResultSet)oOv.getData(ObsType.VIS, lTimestamp, lTimestamp + 1, oWay.m_nMidLat, oWay.m_nMidLat, oWay.m_nMidLon, oWay.m_nMidLon, lLongTsUpdateStart);
							...
							oCur = null;
							ImrcpObsResultSet oWindSpeeds = (ImrcpObsResultSet)oOv.getData(ObsType.SPDWND, lTimestamp, lTimestamp + 1, oWay.m_nMidLat, oWay.m_nMidLat, oWay.m_nMidLon, oWay.m_nMidLon, lLongTsUpdateStart);
							...
							oCur = null;
							ImrcpObsResultSet oPrecipRates = (ImrcpObsResultSet)oOv.getData(ObsType.RTEPC, lTimestamp, lTimestamp + 1, oWay.m_nMidLat, oWay.m_nMidLat, oWay.m_nMidLon, oWay.m_nMidLon, lLongTsUpdateStart);
