...
public class SecureBaseBlock extends BaseBlock
{
	...
	public void reset()
	{
		m_nMethodIndex = m_oConfig.getInt("metidx", 3);
		m_sGroups = m_oConfig.getStringArray("groups", "");
	}
	
	
	/**
	 * Wrapper for {@link #doPost(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)}
	 * 
