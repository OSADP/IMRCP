...
let g_oLayers = 
{
	...
	'network-polygons-map': {'id': 'network-polygons-map', 'minzoom':0, 'maxzoom':6, 'type': 'fill', 'source': 'network-polygons', 'paint':{'fill-opacity': ['case', ['boolean', ['feature-state', 'delete'], false], 0, ['boolean', ['feature-state', 'hover'], false], 1.0, ['boolean', ['get', 'hidden'], false], 0.0, 0.6], 'fill-color': ['match', ['get', 'displaystatus'], 0, '#808080', 1, '#006400', 2, '#9370db', 3, '#90ee90', 4, '#ff3333', '#ff3333']}},
	'network-polygons-report': {'id': 'network-polygons-report', 'minzoom':0, 'maxzoom':10, 'type': 'fill', 'source': 'network-polygons', 'paint':{'fill-opacity': ['case', ['boolean', ['feature-state', 'hover'], false], 1.0, 0.6], 'fill-color': ['match', ['get', 'displaystatus'], 0, '#808080', 1, '#006400', 2, '#9370db', 3, '#90ee90', 4, '#ff3333', '#ff3333']}},
