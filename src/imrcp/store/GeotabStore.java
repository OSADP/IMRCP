...
public class GeotabStore extends CsvStore
{
	 ...
	 */
	@Override
	public void getData(ObsList oReturn, int nType, long lStartTime, long lEndTime,
	 ...
	 */
	@Override
	public void getDataFromFile(ObsList oReturn, int nType, long lStartTime, long lEndTime,
